...
Phase-1 variant for **transforming an existing system** (spreadsheet, desktop app, old codebase, paper process). The legacy system is the golden source: extract its knowledge with traceability, classify what is domain and what is instance, and arbitrate conflicts with the system author.
