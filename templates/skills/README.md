...
- **Body written for the adopter's agent** — the instructions address the agent running inside the adopting project, referencing that project's files (`ideas/inbox.md`, `.claude/memory/`, its charter) rather than anything in this repo.
