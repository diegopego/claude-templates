...
The project keeps an **idea inbox** at `ideas/inbox.md` — the owner's scratchpad of half-formed ideas (see the charter's *Ideas & specs* section). Capturing an idea is a one-line append and needs no skill. **Graduating** one is the valuable step, and this skill drives it: a rough note becomes a well-formed spec with its decisions traceable, and earns a place on the roadmap.
